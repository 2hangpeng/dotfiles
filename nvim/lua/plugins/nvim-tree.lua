...
-- https://github-com.translate.goog/nvim-tree/nvim-tree.lua/issues/1005?_x_tr_sl=auto&_x_tr_tl=zh-CN&_x_tr_hl=zh-CN#issuecomment-1183468091
-- https://github.com/nvim-tree/nvim-tree.lua/wiki/Recipes#fix-tab-titles-when-opening-file-in-new-tab
